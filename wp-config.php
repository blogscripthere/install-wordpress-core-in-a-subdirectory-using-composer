...
define('DB_NAME', 'scripthere');

/** MySQL database username */
define('DB_USER', 'root');

/** MySQL database password */
define('DB_PASSWORD', 'narendra123');
 ...
 */
define( 'SITE_NAME', 'scripthere');

/**
 * Dynamic home and site URLs to handle both websites in all environments.
 */
define( 'WP_SITEURL', 'http://' . $_SERVER['HTTP_HOST'] .'/'. SITE_NAME.'/core' );
define( 'WP_HOME', 'http://' . $_SERVER['HTTP_HOST'].'/'.SITE_NAME);
